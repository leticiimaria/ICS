...
SECRET_KEY = 'django-insecure-nn55bo%0at@ugbo4!39og)g!c9i^n4wajoofmea9aa!s92%6$6'
...
DATABASES = {
    'default': {
        ...
        'USER': 'leticia_hemilly',
        'PASSWORD': 'letml05',
        'HOST': 'localhost', # Pode ser alterado para o host do seu MySQL
